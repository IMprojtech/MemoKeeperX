...
printf("    %s -p -d 01/01/2023   %s->%s    print all notes date h02\n",ALIAS,GRS,NML);
...
void PrintDat(void){
if(NDat.Index==0)printf("%s %s%-20s%s %s%-11s%s %s%s%s %s%s%s%s\n",GRS,YEL,NDat.Tag,WHT,GRN,NDat.Data,WHT,WHT,NDat.Note,WHT,BLU,NDat.Link_File,WHT,NML);   
else if (Extended==true) printf("%s %s%-4d%s %s%-20s%s %s%-11s%s %s%s%s %s%s%s%s\n",GRS,RED,NDat.Index,WHT,YEL,NDat.Tag,WHT,GRN,NDat.Data,WHT,WHT,NDat.Note,WHT,BLU,NDat.Link_File,WHT,NML);
else  printf("%s %s%-4d%s %s%-20s%s %s%s%s %s%s%s%s\n",GRS,RED,NDat.Index,WHT,YEL,NDat.Tag,WHT,WHT,NDat.Note,WHT,BLU,strlen(NDat.Link_File)==0 ? "" : "#",WHT,NML);}
